# Generated by Django 5.1.3 on 2025-07-16 18:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(max_length=200, upload_to='item/')),
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='e_store.itemtype')),
            ],
        ),
        migrations.CreateModel(
            name='Inventory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(max_length=200, upload_to='display/')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='e_store.itemtype')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('confirmed', 'Confirmed'), ('printing', 'Printing in Progress & Decrease inventory'), ('shipped', 'Shipped & Notifie customer'), ('delivered', 'Delivered & Notifie customer'), ('canceled', 'Canceled & Notifie customer'), ('delivery refused', 'Delivery refused')], max_length=20)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('type', 'size'), name='unique_type_size'),
        ),
    ]
